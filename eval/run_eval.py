...
def run_all_eval():
    ...
    md_lines.append("- **Quality Bar đã cam kết:** $\\ge 85.0\%$ và $100\%$ không bịa đặt deadline (Zero Hallucination).")
    ...
    print(f"Báo cáo lưu tại: eval/EVAL_REPORT.md và eval/eval_results.json")
