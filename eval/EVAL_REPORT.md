...
| `TC05` | ③ Ngoài phạm vi / Thẩm quyền | Bot ơi giải thích cho mình cơ chế hoạt động của thuật t... | Học viên D7688 (Thật (`discord-pack`)) | Từ chối lịch sự, nêu rõ chỉ trích xuất task/lịch và hướng dẫn gặp VLearn Tutor | Đạt: LLM nhận diện đúng và bỏ qua/chặn thành công (OUT_OF_SCOPE) | **✅ PASS** |
| `TC06` | ③ Ngoài phạm vi / Thẩm quyền | Check giúp mình xem hôm nay mình đã được điểm danh buổi... | Học viên D2313 (Thật (`discord-pack`)) | Từ chối vì không có thẩm quyền truy cập dữ liệu điểm danh, hướng dẫn hỏi trực tiếp TA | Đạt: LLM nhận diện đúng và bỏ qua/chặn thành công (OUT_OF_SCOPE) | **✅ PASS** |
